namespace Writer
{
    ...
    internal class FtpConfigurationDialog : Dialog 
    {
        ...
        {
            if (this.ftpServerTextBox.Text != string.Empty && this.usernameTextBox.Text != string.Empty && this.portTextBox.Text != string.Empty)
            {
        ...
        {
            this.okButton.Enabled = IsComplete();
        }
        ...
        {
            get { return this.ftpServerTextBox.Text; }
            set { this.ftpServerTextBox.Text = value; }
        }
        ...
        {
            get { return this.subdirectoryTextBox.Text; }
            set { this.subdirectoryTextBox.Text = value; }
        }
        ...
        {
            set { this.storePasswordRadioButton.Checked = value; }
        }
    }
}